...
public class RSItemRegistry
{
    ...
    public static final Map<DyeColor, RegistryObject<BlockItem>> TRAFFIC_CONE_ITEMS = Arrays.stream(DyeColor.values()).map(type -> Pair.of(type,
        ITEMS.register(type.getString() + "_traffic_cone", () -> new BlockItem(RSBlockRegistry.TRAFFIC_CONE_BLOCKS.get(type).get(), new Item.Properties().group(ModItemGroups.ROADSTUFF))))).collect(
    ...
    public static final Map<DyeColor, RegistryObject<BlockItem>> TRAFFIC_BARREL_ITEMS = Arrays.stream(DyeColor.values()).map(type -> Pair.of(type,
        ITEMS.register(type.getString() + "_traffic_barrel", () -> new BlockItem(RSBlockRegistry.TRAFFIC_BARREL_BLOCKS.get(type).get(), new Item.Properties().group(ModItemGroups.ROADSTUFF))))).collect(
            Collectors.toMap(Pair::getKey, Pair::getValue));
    public static final Map<DyeColor, RegistryObject<BlockItem>> TRAFFIC_BOLLARD_ITEMS = Arrays.stream(DyeColor.values()).map(type -> Pair.of(type,
        ITEMS.register(type.getString() + "_traffic_bollard", () -> new BlockItem(RSBlockRegistry.TRAFFIC_BOLLARD_BLOCKS.get(type).get(), new Item.Properties().group(ModItemGroups.ROADSTUFF))))).collect(
            Collectors.toMap(Pair::getKey, Pair::getValue));

    public static final Map<DyeColor, RegistryObject<BlockItem>> CYLINDRICAL_BOLLARD_ITEMS = Arrays.stream(
        DyeColor.values()).map(
            type -> Pair.of(type,
                ITEMS.register(type.getString() + "_cylindrical_bollard",
                    () -> new BlockItem(RSBlockRegistry.CYLINDRICAL_BOLLARD_BLOCKS.get(type).get(), new Item.Properties().group(ModItemGroups.ROADSTUFF))))).collect(
                        Collectors.toMap(Pair::getKey, Pair::getValue));
    ...
    public static final Map<DyeColor, RegistryObject<ReflectorBlockItem>> REFLECTOR_ITEMS = Arrays.stream(DyeColor.values()).map(type -> Pair.of(type,
        ITEMS.register(type.getString() + "_reflector", () -> new ReflectorBlockItem(RSBlockRegistry.REFLECTOR_BLOCKS.get(type).get(), new Item.Properties().group(ModItemGroups.ROADSTUFF), false)))).collect(
            Collectors.toMap(Pair::getKey, Pair::getValue));
    public static final Map<DyeColor, RegistryObject<ReflectorBlockItem>> LUMINESCENT_REFLECTOR_ITEMS = Arrays.stream(DyeColor.values()).map(type -> Pair.of(type,
        ITEMS.register(type.getString() + "_luminescent_reflector",
    ...
    public static final Map<DyeColor, RegistryObject<BlockItem>> GUARDRAIL_ITEMS = Arrays.stream(DyeColor.values()).map(type -> Pair.of(type,
        ITEMS.register(type.getString() + "_guardrail", () -> new BlockItem(RSBlockRegistry.GUARDRAIL_BLOCKS.get(type).get(), new Item.Properties().group(ModItemGroups.ROADSTUFF))))).collect(
            Collectors.toMap(Pair::getKey, Pair::getValue));
